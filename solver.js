...
const PIECE_ROTATIONS = Object.fromEntries(Object.entries(PIECES).map(([name, coords]) => [
    name,
...
class PuzzleSolver {
    ...
    solverSetup() {
        this.solution =
            Array.from({ length: this.rows }, () => Array(this.cols).fill(0));
